...
export const CreateFoodModal: React.FC<CreateFoodModalProps> = ({ onClose }) => {
  ...
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-900/40 backdrop-blur-md overflow-x-hidden overflow-y-auto" 
      dir="rtl"
    >
      <div 
      ...
      <motion.div 
        ...
        className="bg-brand-cream w-full max-w-md rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col max-h-[90vh] relative z-10 overflow-hidden border border-brand-sand m-4"
      >
